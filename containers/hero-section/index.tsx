...
const HeroSection: FC<HeroSectionProps> = ({ }) => {
    ...
    return (
        <section className='w-full h-max flex justify-center pt-40  bg-[--body-bg]'>
            <div className='flex flex-col  overflow-hidden   gap-[4rem] xl:gap-40 items-center page-format relative'>
                <div className='absolute w-full h-full top-0 z-10' />
                <div className='flex flex-col gap-3 items-center relative z-10 xl:top-10'>
                    <SectionTitle xl badgeText='New: Our AI integration just landed' title='Think better with Reflect' description='Never miss a note, idea or connection.' mobileSplitFrom='Think better'/>
                </div>
